...
const Navbar = () => {
    ...
    <nav className="w-full fixed flex justify-center opacity-1000 bg-slate-50">
        <div className="w-full max-w-[80%] grid grid-cols-3 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-4 items-center justify-items-center">
            ...
            <div className="flex items-center p-2 xl:hidden md:flex">
